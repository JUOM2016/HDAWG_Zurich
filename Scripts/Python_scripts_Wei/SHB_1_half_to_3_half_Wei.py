# -*- coding: utf-8 -*-
"""
Created on Wed Sep 14 11:22:43 2022
...
chirpAmplitude_burning_back = 0.03; # V; amplitude of burn-back
...
freq_sweeping_cleaning=0.8E6 # Hz; set the scanning frequency range of cleaning (the actual scanning range should be 4*freq_detuning)
cleaning_duration=0.5e-3 # s; burning time cleaning

#centre_freq_reading=247.6E6; # Hz; Central frequency set to read out the burned spectral hole
#chirpAmplitude_reading = 0.10; # V; amplitude of reading-out pulse
#freq_sweeping_reading=0E6;
...
HDAWG_filename = ('C:\Codes\HDAWG\Sequences\SHB_1_half_to_3_half_Wei.txt')
